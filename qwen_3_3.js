 ...
 *   B200: tp=4
 *   B300: tp=2
 *   MI300X: tp=8 (80GB memory)
 *   MI325X: tp=4 (256GB memory)
 *   MI355X: tp=4 (192GB memory)
 *
...
const Qwen35ConfigGenerator = () => {
  const config = {
    ...
    modelConfigs: {
      ...
      mi300x: { bf16: { tp: 16, mem: 0.8 }, fp8: { tp: 8, mem: 0.8 } },
      mi325x: { bf16: { tp: 8, mem: 0.8 }, fp8: { tp: 4, mem: 0.8 } },
      mi355x: { bf16: { tp: 8, mem: 0.8 }, fp8: { tp: 4, mem: 0.8 } }
    },
